...
REM
REM Generated by Vivado on Fri Dec 12 19:32:17 +0100 2025
...
echo "xvhdl --incr --relax -prj tb_Affichage_vhdl.prj"
call xvhdl  --incr --relax -prj tb_Affichage_vhdl.prj -log xvhdl.log
